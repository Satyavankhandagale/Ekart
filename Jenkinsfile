pipeline {     
	...
	stage('Deploy To K8s') {             
		steps { 
                	withKubeConfig(caCertificate: '', clusterName: '', contextName: '', credentialsId: 'k8s-token2', namespace: 'webapps', restrictKubeConfigAccess: false, serverUrl: 'https://172.31.14.196:6443') {
